    ...
    useEffect(() => {
        if (open) {
            if (initialValues) {
                ...
                form.resetFields();
                form.setFieldsValue({ isActive: true, parentId: null, displayOrder: 1 });
            }
        }
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Input placeholder="VD: Đồ ăn vặt, Nước uống..." className="rounded-lg py-2" />
                </Form.Item>
                ...
                <Form.Item name="isActive" valuePropName="checked" className="mb-0">
                    <Checkbox className="text-gray-600 font-medium">Đang hoạt động</Checkbox>
                </Form.Item>
            </Form>
        </Modal>
    );
