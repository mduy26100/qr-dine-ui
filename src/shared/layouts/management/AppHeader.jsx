...
import { useLogout } from "../../../features/management/auth";

const { Header } = Layout;

const AppHeader = ({ collapsed, setCollapsed, isMobile, setIsOpen, user }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <button
          onClick={() =>
            isMobile ? setIsOpen(true) : setCollapsed(!collapsed)
          }
